...
public class MenuUsuario extends JFrame {
	...
	public MenuUsuario() {
	    ...
	    JLabel lblTituloPrincipal = new JLabel("HotelReserveUSF");
	    ...
	    String textoDescripcion = "<html><body>Sistema HotelReserveUSF. Controle e gerencie de forma otimizada e fácil <br> o fluxo de reservas e hóspedes do hotel   </body></html>";
